...
set Cities := {<"Tel Aviv",5,16>, <"Yafo",6,18>, <"Jerusalem",25,8>, <"Tveria",40,90>, <"Nahariya",6,95>, <"Eilat",30,-103>,
...
set AllPossibleCombinations := Steps * CitiesNames * CitiesNames;
...
minimize distance:    
    sum <step,src,x1,y1,dest,x2,y2> in Steps * Cities * Cities: 
        Edges[step,src,dest] * sqrt((x1-x2)**2 + (y1-y2)**2);