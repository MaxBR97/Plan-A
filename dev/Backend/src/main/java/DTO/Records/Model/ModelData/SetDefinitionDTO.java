 ...
 * @param types the types the set is made of, size one if its a normal set, or the types of its composition if its complex
 */
public record SetDefinitionDTO(String name, List<String> composition, List<DataTypes> types) {
}
